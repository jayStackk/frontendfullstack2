...
import  MockedComponent  from '../ModalComponent/ModelComponent'
...
<Row>
    ...
    <Col className="text-center" lg={6} xs={6}><MockedComponent></MockedComponent></Col>
        ...
        <Col lg={8}>
          ...
          <Row>
            <p className="profileHeaderText">
              Rank - <img style={{ height: 40 }} src={blackbelt} />
            </p>
          </Row>
          <Row>
            <Col lg={7}>
